...
I found many useful visualizations for COVID-19 tracking at https://covidtracking.com and also at https://ourworldindata.org/coronavirus. However, many of those graphics display cumulative counts and I found it hard to identify trends. This web application allows the user to select a US State and selected COVID-19 daily count data, and view a simple running record, and a Shewhart chart.
